...
class FastqDataset:
    def __new__(cls,file_path:str, chunk_size:int): ...
    ...
    @staticmethod
    def from_file(file_path:str, chunk_size:int) -> FastqDataset:
        ...

    def get_stats(self) -> typing.Any:
        ...

    def get_records(self, start:int, end:int) -> list[FastqRecord]:
        ...

    def get_records_indexed(self, start:int, end:int) -> list[FastqRecord]:
        ...

    def get_records_sequential(self, start:int, end:int) -> list[FastqRecord]:
        ...
...
class FastqRecord:
    ...
    sequence: str
    quality: str
    def __new__(cls,header:str, sequence:str, quality:str): ...
