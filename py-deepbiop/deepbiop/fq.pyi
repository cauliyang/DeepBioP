...
class TensorEncoder:
    ...
    def __new__(cls,option:FqEncoderOption, tensor_max_width:typing.Optional[int], tensor_max_seq_len:typing.Optional[int]): ...
...
def encode_fq_path_to_tensor(fq_path:str | os.PathLike | pathlib.Path,k:int,bases:str,qual_offset:int,vectorized_target:bool,max_width:typing.Optional[int],max_seq_len:typing.Optional[int]) -> tuple[numpy.typing.NDArray[numpy.int32], numpy.typing.NDArray[numpy.int32], numpy.typing.NDArray[numpy.int32], dict[str, int]]:
    ...
...
def encode_fq_paths_to_tensor(fq_paths:typing.Sequence[str | os.PathLike | pathlib.Path],k:int,bases:str,qual_offset:int,vectorized_target:bool,parallel_for_files:bool,max_width:typing.Optional[int],max_seq_len:typing.Optional[int]) -> tuple[numpy.typing.NDArray[numpy.int32], numpy.typing.NDArray[numpy.int32], numpy.typing.NDArray[numpy.int32], dict[str, int]]:
    ...
...
def load_predicts_from_batch_pts(pt_path:str | os.PathLike | pathlib.Path,ignore_label:int,id_table:typing.Mapping[int, str],max_predicts:typing.Optional[int]) -> dict[str, Predict]:
    ...
