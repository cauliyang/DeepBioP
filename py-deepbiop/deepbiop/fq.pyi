...
class LengthFilter:
    ...
    def passes(self, sequence: builtins.bytes) -> builtins.bool: ...
    @property
...
@typing.final
class QualityFilter:
    """Filter FASTQ records by quality scores."""
    ...
    def passes(
        self, sequence: builtins.bytes, quality: builtins.bytes
    ) -> builtins.bool: ...
    def calculate_mean_quality(self, quality: builtins.bytes) -> builtins.float: ...
    @property
...
@typing.final
class Deduplicator:
    """Remove duplicate sequences from FASTQ records."""

    def __new__(cls) -> Deduplicator: ...
    @staticmethod
    def remove_all_duplicates() -> Deduplicator: ...
    def is_duplicate(self, sequence: builtins.bytes) -> builtins.bool: ...
    def passes(self, sequence: builtins.bytes) -> builtins.bool: ...
    def unique_count(self) -> builtins.int: ...
    def clear(self) -> None: ...
    @property
    def keep_first(self) -> builtins.bool: ...

@typing.final
class Subsampler:
    """Subsample FASTQ records using various strategies."""
...
class ReverseComplement:
    ...
    @staticmethod
    def for_rna() -> ReverseComplement: ...
    def apply(self, sequence: builtins.bytes) -> builtins.bytes: ...

@typing.final
class Mutator:
    """Random point mutation augmenter for sequences."""
    ...
    @staticmethod
    def for_rna(
        mutation_rate: builtins.float, seed: builtins.int | None = None
    ) -> Mutator: ...
    def apply(self, sequence: builtins.bytes) -> builtins.bytes: ...

@typing.final
class Sampler:
    """Random subsequence sampler for sequence data."""

    @staticmethod
    def random(length: builtins.int, seed: builtins.int | None = None) -> Sampler: ...
    @staticmethod
    def from_start(length: builtins.int) -> Sampler: ...
    @staticmethod
    def from_center(length: builtins.int) -> Sampler: ...
    @staticmethod
    def from_end(length: builtins.int) -> Sampler: ...
    def apply(self, sequence: builtins.bytes) -> builtins.bytes: ...
