...
We use [GitHub issues](https://github.com/cauliyang/DeepBioP/issues/) to track bugs and suggested enhancements.
You can report a bug by opening a [new issue](https://github.com/cauliyang/DeepBioP/issues/).
...
We use [GitHub issues](https://github.com/cauliyang/DeepBioP/issues/) to track bugs and suggested enhancements.
You can suggest an enhancement by opening a [new feature request](https://github.com/cauliyang/DeepBioP/issues/new?labels=enhancement&template=feature_request.yml).
...
Pick an issue by going through the [issue tracker](https://github.com/cauliyang/DeepBioP/issues) and finding an issue you would like to work on.
Feel free to pick any issue with an [accepted](https://github.com/cauliyang/DeepBioP/issues?q=is%3Aopen+is%3Aissue+label%3Aaccepted) label that is not already assigned.
We use the [help wanted](https://github.com/cauliyang/DeepBioP/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) label to indicate issues that are high on our wishlist.

If you are a first time contributor, you might want to look for issues labeled [good first issue](https://github.com/cauliyang/DeepBioP/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22).
...
```bash
git clone https://github.com/<username>/DeepBioP.git
cd DeepBioP
```
